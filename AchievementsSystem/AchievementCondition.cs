...
namespace CookieClicker.AchievementsSystem
{
    ...
    public abstract class AchievementCondition
    {
        ...
        protected AchievementCondition(string name) => Name = name;

        public virtual void Load(JObject state) => _isCompleted = (bool)state["Completed"];

        public virtual void Clear() => _isCompleted = false;
